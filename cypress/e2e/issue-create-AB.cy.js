...
function successValidation() {
  // validate success message and reload the page asserting that it doesn't exist
...
describe("Issue create", () => {
  ...
  it("Test that should create an issue and validate it successfully", () => {
    cy.get('[data-testid="modal:issue-create"]').within(() => {
  ...
  it("Should create an issue with ramdom title and description, while the validation is successful", () => {
    cy.get('[data-testid="modal:issue-create"]').within(() => {
